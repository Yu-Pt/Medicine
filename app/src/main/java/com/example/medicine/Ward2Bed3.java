...
public class Ward2Bed3 extends AppCompatActivity {
    FirebaseAuth mAuth;
    ImageView avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ward2_bed3);

        avatar = findViewById(R.id.ward2bed3_avatar);
        name = findViewById(R.id.ward2bed3_name);
        hp = findViewById(R.id.ward2bed3_hp);
        give1 = findViewById(R.id.ward2bed3_give1);
        give2 = findViewById(R.id.ward2bed3_give2);
        give3 = findViewById(R.id.ward2bed3_give3);
        give = findViewById(R.id.ward2bed3_give);
        back = findViewById(R.id.ward2bed3_back);
        tabl1 = findViewById(R.id.ward2bed3_tabl1);
        tabl2 = findViewById(R.id.ward2bed3_tabl2);
        tabl3 = findViewById(R.id.ward2bed3_tabl3);
        tabl4 = findViewById(R.id.ward2bed3_tabl4);
        tabl5 = findViewById(R.id.ward2bed3_tabl5);
        rast1 = findViewById(R.id.ward2bed3_rast1);
        rast2 = findViewById(R.id.ward2bed3_rast2);
        rast3 = findViewById(R.id.ward2bed3_rast3);
        rast4 = findViewById(R.id.ward2bed3_rast4);
        rast5 = findViewById(R.id.ward2bed3_rast5);
        maz1 = findViewById(R.id.ward2bed3_maz1);
        maz2 = findViewById(R.id.ward2bed3_maz2);
        maz3 = findViewById(R.id.ward2bed3_maz3);
        maz4 = findViewById(R.id.ward2bed3_maz4);
        maz5 = findViewById(R.id.ward2bed3_maz5);
        aero1 = findViewById(R.id.ward2bed3_aero1);
        aero2 = findViewById(R.id.ward2bed3_aero2);
        aero3 = findViewById(R.id.ward2bed3_aero3);
        aero4 = findViewById(R.id.ward2bed3_aero4);
        aero5 = findViewById(R.id.ward2bed3_aero5);
        great = findViewById(R.id.ward2bed3_great);
        discharge = findViewById(R.id.ward2bed3_discharge);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ward2Bed3.this, Ward2.class);
                ...
                ref.child("Wards").child(id).child("ward2bed3").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            hp.setText(newHP + "%");
                            ref.child("Wards").child(id).child("ward2bed3").child("hp").setValue(newHP);
                            ref.child("Wards").child(id).child("ward2bed3").child("bool").setValue("true");
    ...
    public void hp100() {
        ...
        discharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ref.child("Wards").child(id).child("ward2bed3").child("adress").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("bool").setValue("false");
                ref.child("Wards").child(id).child("ward2bed3").child("diag").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("gender").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("hp").setValue(100);
                ref.child("Wards").child(id).child("ward2bed3").child("image").setValue("out");
                ref.child("Wards").child(id).child("ward2bed3").child("name").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("symp").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("vrach").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed3").child("id").setValue("empty");
                ref.child("User").child(id).child("wards").child("ward2bed3").setValue("0");
