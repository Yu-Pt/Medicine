...
public class Ward1Bed1 extends AppCompatActivity {
    FirebaseAuth mAuth;
    ImageView avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ward1_bed1);

        avatar = findViewById(R.id.ward1bed1_avatar);
        name = findViewById(R.id.ward1bed1_name);
        hp = findViewById(R.id.ward1bed1_hp);
        give1 = findViewById(R.id.ward1bed1_give1);
        give2 = findViewById(R.id.ward1bed1_give2);
        give3 = findViewById(R.id.ward1bed1_give3);
        give = findViewById(R.id.ward1bed1_give);
        back = findViewById(R.id.ward1bed1_back);
        tabl1 = findViewById(R.id.ward1bed1_tabl1);
        tabl2 = findViewById(R.id.ward1bed1_tabl2);
        tabl3 = findViewById(R.id.ward1bed1_tabl3);
        tabl4 = findViewById(R.id.ward1bed1_tabl4);
        tabl5 = findViewById(R.id.ward1bed1_tabl5);
        rast1 = findViewById(R.id.ward1bed1_rast1);
        rast2 = findViewById(R.id.ward1bed1_rast2);
        rast3 = findViewById(R.id.ward1bed1_rast3);
        rast4 = findViewById(R.id.ward1bed1_rast4);
        rast5 = findViewById(R.id.ward1bed1_rast5);
        maz1 = findViewById(R.id.ward1bed1_maz1);
        maz2 = findViewById(R.id.ward1bed1_maz2);
        maz3 = findViewById(R.id.ward1bed1_maz3);
        maz4 = findViewById(R.id.ward1bed1_maz4);
        maz5 = findViewById(R.id.ward1bed1_maz5);
        aero1 = findViewById(R.id.ward1bed1_aero1);
        aero2 = findViewById(R.id.ward1bed1_aero2);
        aero3 = findViewById(R.id.ward1bed1_aero3);
        aero4 = findViewById(R.id.ward1bed1_aero4);
        aero5 = findViewById(R.id.ward1bed1_aero5);
        great = findViewById(R.id.ward1bed1_great);
        discharge = findViewById(R.id.ward1bed1_discharge);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ward1Bed1.this, Ward1.class);
                ...
                ref.child("Wards").child(id).child("ward1bed1").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            hp.setText(newHP + "%");
                            ref.child("Wards").child(id).child("ward1bed1").child("hp").setValue(newHP);
                            ref.child("Wards").child(id).child("ward1bed1").child("bool").setValue("true");
    ...
    public void hp100() {
        ...
        discharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ref.child("Wards").child(id).child("ward1bed1").child("adress").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("bool").setValue("false");
                ref.child("Wards").child(id).child("ward1bed1").child("diag").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("gender").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("hp").setValue(100);
                ref.child("Wards").child(id).child("ward1bed1").child("image").setValue("out");
                ref.child("Wards").child(id).child("ward1bed1").child("name").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("symp").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("vrach").setValue("empty");
                ref.child("Wards").child(id).child("ward1bed1").child("id").setValue("empty");
                ref.child("User").child(id).child("wards").child("ward1bed1").setValue("0");
