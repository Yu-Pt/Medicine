...
public class Ward2Bed2 extends AppCompatActivity {
    FirebaseAuth mAuth;
    ImageView avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ward2_bed2);

        avatar = findViewById(R.id.ward2bed2_avatar);
        name = findViewById(R.id.ward2bed2_name);
        hp = findViewById(R.id.ward2bed2_hp);
        give1 = findViewById(R.id.ward2bed2_give1);
        give2 = findViewById(R.id.ward2bed2_give2);
        give3 = findViewById(R.id.ward2bed2_give3);
        give = findViewById(R.id.ward2bed2_give);
        back = findViewById(R.id.ward2bed2_back);
        tabl1 = findViewById(R.id.ward2bed2_tabl1);
        tabl2 = findViewById(R.id.ward2bed2_tabl2);
        tabl3 = findViewById(R.id.ward2bed2_tabl3);
        tabl4 = findViewById(R.id.ward2bed2_tabl4);
        tabl5 = findViewById(R.id.ward2bed2_tabl5);
        rast1 = findViewById(R.id.ward2bed2_rast1);
        rast2 = findViewById(R.id.ward2bed2_rast2);
        rast3 = findViewById(R.id.ward2bed2_rast3);
        rast4 = findViewById(R.id.ward2bed2_rast4);
        rast5 = findViewById(R.id.ward2bed2_rast5);
        maz1 = findViewById(R.id.ward2bed2_maz1);
        maz2 = findViewById(R.id.ward2bed2_maz2);
        maz3 = findViewById(R.id.ward2bed2_maz3);
        maz4 = findViewById(R.id.ward2bed2_maz4);
        maz5 = findViewById(R.id.ward2bed2_maz5);
        aero1 = findViewById(R.id.ward2bed2_aero1);
        aero2 = findViewById(R.id.ward2bed2_aero2);
        aero3 = findViewById(R.id.ward2bed2_aero3);
        aero4 = findViewById(R.id.ward2bed2_aero4);
        aero5 = findViewById(R.id.ward2bed2_aero5);
        great = findViewById(R.id.ward2bed2_great);
        discharge = findViewById(R.id.ward2bed2_discharge);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ward2Bed2.this, Ward2.class);
                ...
                ref.child("Wards").child(id).child("ward2bed2").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            hp.setText(newHP + "%");
                            ref.child("Wards").child(id).child("ward2bed2").child("hp").setValue(newHP);
                            ref.child("Wards").child(id).child("ward2bed2").child("bool").setValue("true");
    ...
    public void hp100() {
        ...
        discharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ref.child("Wards").child(id).child("ward2bed2").child("adress").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("bool").setValue("false");
                ref.child("Wards").child(id).child("ward2bed2").child("diag").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("gender").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("hp").setValue(100);
                ref.child("Wards").child(id).child("ward2bed2").child("image").setValue("out");
                ref.child("Wards").child(id).child("ward2bed2").child("name").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("symp").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("vrach").setValue("empty");
                ref.child("Wards").child(id).child("ward2bed2").child("id").setValue("empty");
                ref.child("User").child(id).child("wards").child("ward2bed2").setValue("0");
