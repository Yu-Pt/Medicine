...
public class BedVip extends AppCompatActivity {
    FirebaseAuth mAuth;
    ImageView avatar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bed_vip);

        avatar = findViewById(R.id.bedvip_avatar);
        name = findViewById(R.id.bedvip_name);
        hp = findViewById(R.id.bedvip_hp);
        give1 = findViewById(R.id.bedvip_give1);
        give2 = findViewById(R.id.bedvip_give2);
        give3 = findViewById(R.id.bedvip_give3);
        give = findViewById(R.id.bedvip_give);
        back = findViewById(R.id.bedvip_back);
        tabl1 = findViewById(R.id.bedVip_tabl1);
        tabl2 = findViewById(R.id.bedVip_tabl2);
        tabl3 = findViewById(R.id.bedVip_tabl3);
        tabl4 = findViewById(R.id.bedVip_tabl4);
        tabl5 = findViewById(R.id.bedVip_tabl5);
        rast1 = findViewById(R.id.bedVip_rast1);
        rast2 = findViewById(R.id.bedVip_rast2);
        rast3 = findViewById(R.id.bedVip_rast3);
        rast4 = findViewById(R.id.bedVip_rast4);
        rast5 = findViewById(R.id.bedVip_rast5);
        maz1 = findViewById(R.id.bedVip_maz1);
        maz2 = findViewById(R.id.bedVip_maz2);
        maz3 = findViewById(R.id.bedVip_maz3);
        maz4 = findViewById(R.id.bedVip_maz4);
        maz5 = findViewById(R.id.bedVip_maz5);
        aero1 = findViewById(R.id.bedVip_aero1);
        aero2 = findViewById(R.id.bedVip_aero2);
        aero3 = findViewById(R.id.bedVip_aero3);
        aero4 = findViewById(R.id.bedVip_aero4);
        aero5 = findViewById(R.id.bedVip_aero5);
        great = findViewById(R.id.bedvip_great);
        discharge = findViewById(R.id.bedvip_discharge);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BedVip.this, WardVIP.class);
                ...
                ref.child("Wards").child(id).child("wardvip").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            hp.setText(newHP + "%");
                            ref.child("Wards").child(id).child("wardvip").child("hp").setValue(newHP);
                            ref.child("Wards").child(id).child("wardvip").child("bool").setValue("true");
    ...
    public void hp100() {
        ...
        discharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ref.child("Wards").child(id).child("wardvip").child("adress").setValue("empty");
                ref.child("Wards").child(id).child("wardvip").child("bool").setValue("false");
                ref.child("Wards").child(id).child("wardvip").child("diag").setValue("empty");
                ref.child("Wards").child(id).child("wardvip").child("gender").setValue("empty");
                ref.child("Wards").child(id).child("wardvip").child("hp").setValue(100);
                ref.child("Wards").child(id).child("wardvip").child("image").setValue("out");
                ref.child("Wards").child(id).child("wardvip").child("name").setValue("empty");
                ref.child("Wards").child(id).child("wardvip").child("symp").setValue("empty");
                ref.child("Wards").child(id).child("wardvip").child("id").setValue("empty");
